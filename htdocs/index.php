<?php
    ...
    print("<html>");
        print("<head>");
            ...
            print("<title>IoT Environmental Stations Dashboard</title>");
        print("</head>");
    
        print("<div id=\"bottom-only-border\">");
        print("<h1>IoT Environmental Stations Dashboard</h1>");
        print("</div>");

        $rec_vals_file = fopen("../python_dash_backend/received_values.txt", "r") or die("Unable to open received values file!");
